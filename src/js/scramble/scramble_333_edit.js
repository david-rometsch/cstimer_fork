...
var scramble_333 = (function (getNPerm, setNPerm, getNParity, rn, rndEl) {
  ...
  // NOTE: i used this as second example
  // values get calulated here instead of mapped
  //
  function genZBLLMap() {
    var isVisited = [];
    var zbll_map = [];
  ...
  // NOTE: this is the category of scrambles i used to experiment with
  var pll_map = [
    [0x1032, 0x3210, 1, "H"], // x = hex values, number to show permuttation
    [0x3102, 0x3210, 4, "Ua"], // mapping: [corner-permutation, edge permutation, variation, name]
    [0x3021, 0x3210, 4, "Ub"],
    [0x2301, 0x3210, 2, "Z"],
    [0x3210, 0x3021, 4, "Aa"],
    [0x3210, 0x3102, 4, "Ab"],
  ...
  // NOTE: this is the locig that generates the multi cycle scrambles
  ...
  /*
	...
	*/
  // NOTE: this is the central register for scramble Types
  scrMgr.reg("333", getRandomScramble)("333fm", getFMCScramble)(
    ...
    // NOTE: these are the added 3BLD categorys
    "3bldc0",
    make3BLDCat(0),
  )("3bldc1", make3BLDCat(1))("3bldc2", make3BLDCat(2))(
    "3bldc3",
    make3BLDCat(3),
  )("3bldc4", make3BLDCat(4))("3bldc5", make3BLDCat(5))(
    "3bldc6",
    make3BLDCat(6),
  )("3bldc7", make3BLDCat(7))(
    // NOTE: same for multi-cycle
    "3bldmc0",
    make3BLDMultiCycle(0),
  )("3bldmc1", make3BLDMultiCycle(1))("3bldmc2", make3BLDMultiCycle(2))(
    "3bldmc3",
    make3BLDMultiCycle(3),
    ...
    ollprobs,
    getOLLImage,
  ])("2gll", get2GLLScramble)("sbrx", getSBRouxScramble)(
    "half",
