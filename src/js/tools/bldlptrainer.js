var bldlptrainer = execMain(function () {
  ...
  var dialogInput = $(
    '<textarea style="width:100%;height:8em;box-sizing:border-box;resize:vertical" placeholder="e.g. AF BL XK RU">',
  );
  var dialogStatus = $('<div style="margin-top:4px">');
  var dialogDiv = $('<div style="padding:4px">').append(
    TOOLS_BLDLPTRAINER + " (Speffz, space-separated):",
    $("<br>"),
    dialogInput,
    dialogStatus,
  );
  ...
  function execFunc(fdiv) {
    ...
    var inp = $(
      '<textarea style="width:100%;height:6em;box-sizing:border-box;resize:vertical" placeholder="e.g. AF BL XK RU">',
    );
