...
var PROPERTY_USEINS_STR =
  "Always (down)|Always (up)|Except BLD (down)|Except BLD (up)|Never";
...
var EXPORT_TOFILE = "Export to file"git show 2e7917e --sgit show 2e7917e --stattat;
...
var IMPORT_FINAL_CONFIRM =
  "This will override all local data! It will modify %d sessions, add %a and remove %r solves at least. Confirm to import data?";
...
var TOOLS_SYNCSEED_HELP =
  "If enabled, scramble will only depend on the seed and scramble settings.";
...
var TOOLS_BATTLE_INFO =
  "Join a battle room with your friend, then you will battle together.";
...
var OLCOMP_WCANOTICE =
  "Submit As Your WCA Account? (Relogin if not recognized after submitting)";
...
var PROPERTY_IMGREP =
  "Show virtual cube animation when clicking scramble image";
...
var PROPERTY_ENTERING_STR =
  "timer|typing|stackmat|MoYuTimer|virtual|Bluetooth Cube|qCube|Bluetooth Timer|last layer training";
...
var PROPERTY_COLORS =
  "font color|background color|board color|button color|link color|Logo color|Logo bgcolor";
var PROPERTY_VIEW = "UI style is";
var PROPERTY_VIEW_STR = "Auto|Mobile|Desktop";
var PROPERTY_UIDESIGN = "UI design is";
var PROPERTY_UIDESIGN_STR =
  "Normal|Material design|Normal w/o shadows|Material design w/o shadows";
...
var PROPERTY_COLOR_STR =
  "manual|import/export...|random|style1|style2|style3|black|white|style6|solarized dark|solarized light";
var PROPERTY_FONT = "select timer's font";
var PROPERTY_FONT_STR =
  "random digital|normal|digital1|digital2|digital3|digital4|digital5";
...
var scrdata = [
  ...
  //NOTE: new feature 3BLD corners in left selection in UI and e.g. 3bldc0 in right selection in UI
  [
    "3BLD corners",
    [
  ...
  ["Crazy Puzzle", [["Crazy 3x3x3", "crz3a", 30]]],
  [
    "Cmetrick",
    [
      ["Cmetrick", "cm3", 25],
  ...
  ["Icosahedron", [["Icosamate random move", "ctico", 60]]],
  ["===SPECIAL===", [["--", "blank", 0]]],
  [
    "3x3x3 subsets",
    [
...
var STATS_ALERTMG =
  "Merge all times in session [%f] to the end of session [%t]?";
...
var STATS_STRING =
  "best|current|worst|Generated By csTimer on %Y-%M-%D|solves/total: %d|single|mean of %mk|avg of %mk|Average: %v{ (σ = %sgm)}|Mean: %v|Time List:|solving from %s to %e|Totally spent: %d|target";
...
var STATS_XSESSION_DATE =
  "any date|past 24 hours|past 7 days|past 30 days|past 365 days";
...
var PROPERTY_AUTOEXP_OPT =
  "Never|To File|With csTimer ID|With WCA Account|With Google Account|Alert Only";
...
var GIIKER_REQMACMSG =
  "Please enter the MAC address of your smart hardware (xx:xx:xx:xx:xx:xx). You can find the MAC address through chrome://bluetooth-internals/#devices, or modify following options to let csTimer automatically obtain it:\nChrome: Turn on chrome://flags/#enable-experimental-web-platform-features\nBluefy: Turn on Enable BLE Advertisements";
var GIIKER_NOBLEMSG =
  "Bluetooth API is not available. Ensure https access, check bluetooth is enabled on your device, and try chrome with chrome://flags/#enable-experimental-web-platform-features enabled";
...
var LGHINT_BTINVMAC =
  "Not a valid mac address, cannot connect to your smart cube";
var LGHINT_AEXPABT = "Auto export abort";
var LGHINT_AEXPSUC = "Auto export success";
var LGHINT_AEXPFAL = "Auto export failed";
var EASY_SCRAMBLE_HINT =
  "Change length to limit upper bound of solution length, input 2 digits to limit both lower (<= 8) and upper bound";
